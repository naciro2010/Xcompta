...
!function (a, b) {
    ...
    b.Filtering = b.Component.extend({
        construct: function (a) {
            ...
            var c, d = this, e = a("<div/>", {"class": "input-group footable-filtering-search"}).append(a("<label/>", {
                    "class": "sr-only",
                    text: "Search"
                })), f = a("<div/>", {"class": "input-group"}).appendTo(e),
                g = a("<div/>", {"class": "input-group-append"}), h = a("<button/>", {
                    type: "button",
            ...
            }).on("click", {self: d}, d._onSearchButtonClicked).append(a("<span/>", {"class": "fas fa-search"})), d.$dropdown = a("<ul/>", {"class": "dropdown-menu dropdown-menu-right"}), b.is.emptyString(d.dropdownTitle) || d.$dropdown.append(a("<li/>", {
                "class": "dropdown-item",
                text: d.dropdownTitle
            })), d.$dropdown.append(b.arr.map(d.ft.columns.array, function (b) {
                return b.filterable ? a("<li/>", {'class': 'dropdown-item'}).append(a("<a/>", {"class": "checkbox"}).append(a("<label/>", {html: b.title}).prepend(a("<input/>", {
                    type: "checkbox",
                    checked: !0
            ...
            a ? this.$button.children(".fas").removeClass("fa-times").addClass("fa-search") : this.$button.children(".fas").removeClass("fa-search").addClass("fa-times")
        }, find: function (a) {
            ...
            if (c.hasClass("fa-times")) b.clear(); else {
                var d = b.$input.val();
